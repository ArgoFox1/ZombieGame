...
public class Ak : MonoBehaviour
{
    ...
    public List<GameObject> akCapsules = new List<GameObject>();
    ...
    private List<GameObject> akCapsules2 = new List<GameObject>();
    ...
    {
        canCapsule = false;
        akCapsules[0].gameObject.SetActive(true);
        currentCapsule = akCapsules[0].gameObject;
        akCapsules2.Add(currentCapsule);
        ...
        akCapsules.RemoveAt(0);
        Invoke(nameof(CapsulePool), 1f);
        StartCoroutine(nameof(CoolDown4Capsule));
    }
    private void CapsulePool()
    {
        akCapsules2[0].gameObject.SetActive(false);
        akCapsules.Add(akCapsules2[0]);
        akCapsules2.RemoveAt(0);
    }
    // Fire System And FX
    private void Fire()
    {
    ...
    public void IncreaseAk47Ammo(int value)
    {
        totalAmmo += value;
    }
}
