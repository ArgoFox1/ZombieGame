...
public class M16 : MonoBehaviour
{
    ...
    public List<GameObject> m16Capsules = new List<GameObject>();
    ...
    private List<GameObject> m16Capsules2 = new List<GameObject>();
    ...
    {
        canCapsule = false;
        m16Capsules[0].gameObject.SetActive(true);
        currentCapsule = m16Capsules[0].gameObject;
        m16Capsules2.Add(currentCapsule);
        ...
        m16Capsules.RemoveAt(0);
        Invoke(nameof(CapsulePool), 1f);
        StartCoroutine(nameof(CoolDown4Capsule));
    }
    private void CapsulePool()
    {
        m16Capsules2[0].gameObject.SetActive(false);
        m16Capsules.Add(m16Capsules2[0]);
        m16Capsules2.RemoveAt(0);
    }
    // Fire System And FX
    private void Fire()
    {
    ...
    public void IncreaseM16Ammo(int value)
    {
        totalAmmo += value;
    }
} 
