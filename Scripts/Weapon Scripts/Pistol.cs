...
public class Pistol : MonoBehaviour
{
    ...
    {
        if (totalAmmo != 0 && canReload == true && magAmmo != 7 && magAmmo - currentMagAmmo <= totalAmmo)
        {
        ...
        if (magAmmo - currentMagAmmo >= totalAmmo && canReload == true && totalAmmo != 0 && currentMagAmmo != 7)
        {
    ...
    public void IncreasePistolAmmo(int value)
    {
        totalAmmo += value;
    }
}                                                                           